...
router.put(
  "/userAssignIntoProject/:projectId",
  roleMiddleware([
    UserRoleEnum.ADMINISTRATOR,
    UserRoleEnum.PROJECT_MANAGER,
    UserRoleEnum.TEAM_MEMBER,
...
router.put(
  "/kanban-column/:kanbanColumnId",
  ProjectController.updatekanbanColumn
);
router.delete(
  "/kanban-column/:kanbanColumnId",
  ProjectController.deleteKanbanColumn
);
...
router.put(
  "/projectAssgined/job-title-update/:projectAssignUsersId",
  roleMiddleware([UserRoleEnum.ADMINISTRATOR, UserRoleEnum.PROJECT_MANAGER]),
  ProjectController.updateProjectJobTitle
);
