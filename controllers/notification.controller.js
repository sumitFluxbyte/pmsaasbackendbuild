...
export const getAllNotification = async (req, res) => {
    ...
    return new SuccessResponse(StatusCodes.OK, notifications, "Notifications get successfully").send(res);
};
export const readNotification = async (req, res) => {
    ...
    return new SuccessResponse(StatusCodes.OK, null, "Notifications read successfully").send(res);
};
